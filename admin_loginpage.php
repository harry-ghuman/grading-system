...
?>
<div style="background-image: url('img/blur10.jpg');padding: 40px;height: 500px;background-size: 100%;background-repeat: no-repeat">
<form action="admin_validate_login.php"method="get">
    <table  align="center">
